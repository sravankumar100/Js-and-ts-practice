    ...
    if (creditScore > 750) {  
        ...
        if (income >= 50000) {
            if (isEmployed) {
                ...
                console.log("Loan is denied for " + customerName + " due to unemployment");
            }
        } else {
            console.log("Loan is denied for " + customerName + " due to low income score");
        }
    } 
    else {
...
evaluateloan("John Doe", 720, 55000.0, true, 35.0);
export{};